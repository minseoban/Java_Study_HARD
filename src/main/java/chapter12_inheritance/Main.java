...
/*
    ...
    1. 상속의 필요성
        ...
        위의 과정을 거쳤을 땨 얻을 수 있는 이점 : 중복된 코드를 작성하지 않아도 됨.
    ...
    2. 상속의 특징
        ...
        3) method override : 자식 클래스에서 부모 클랴스의 기본 동작을 '재정의'할 수 있음.
    ...
    3. 상속의 장점
        1) 코드 자새용성 : 동일한 코드를 반복적으로 작성하지 않아도 됨.
...
public class Main {
    public static void main(String[] args) {
        ...
        Animal animal3 = new Animal(2);      // int 매개변수
        Animal animal4 = new Animal("나비", 2);      // 둘다
